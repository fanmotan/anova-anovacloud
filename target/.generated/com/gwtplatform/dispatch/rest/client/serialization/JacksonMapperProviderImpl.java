...
public class JacksonMapperProviderImpl extends AbstractJacksonMapperProvider {
    @Inject
    JacksonMapperProviderImpl(Provider<com_anova_anovacloud_shared_dto_MatterActionDtoMapper> com_anova_anovacloud_shared_dto_MatterActionDtoMapperProvider, 
