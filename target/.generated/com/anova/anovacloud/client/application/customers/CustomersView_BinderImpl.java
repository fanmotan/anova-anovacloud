...
public class CustomersView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.anova.anovacloud.client.application.customers.CustomersView>, com.anova.anovacloud.client.application.customers.CustomersView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.anova.anovacloud.client.application.customers.CustomersView owner) {
   ...
   */
  class Widgets {
    private final com.anova.anovacloud.client.application.customers.CustomersView owner;
    ...
    public Widgets(final com.anova.anovacloud.client.application.customers.CustomersView owner) {
      this.owner = owner;
     ...
     */
    private com.anova.anovacloud.client.application.customers.CustomersView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.anova.anovacloud.client.application.customers.CustomersView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.anova.anovacloud.client.application.customers.CustomersView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.anova.anovacloud.client.application.customers.CustomersView_BinderImpl_GenBundle) GWT.create(com.anova.anovacloud.client.application.customers.CustomersView_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.anova.anovacloud.client.application.customers.CustomersView_BinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.anova.anovacloud.client.application.customers.CustomersView_BinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.anova.anovacloud.client.application.customers.CustomersView_BinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      f_HTMLPanel1.addAndReplaceElement(get_customerGrid(), get_domId3Element().get());
    ...
    private com.google.gwt.user.client.ui.InlineLabel build_f_InlineLabel3() {
      ...
      // Setup section.
      f_InlineLabel3.setText("Customers");
    ...
    private com.google.gwt.user.client.ui.Button build_create() {
      ...
      // Setup section.
      create.ensureDebugId("customerCreate");
    ...
    /**
     * Getter for customerGrid called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.cellview.client.CellTable get_customerGrid() {
      return build_customerGrid();
    }
    private com.google.gwt.user.cellview.client.CellTable build_customerGrid() {
      // Creation section.
      final com.google.gwt.user.cellview.client.CellTable customerGrid = owner.customerGrid;
