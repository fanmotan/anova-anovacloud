...
public class CustomerView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.anova.anovacloud.client.application.customers.customer.CustomerView>, com.anova.anovacloud.client.application.customers.customer.CustomerView.Binder {
  ...
  interface Template extends SafeHtmlTemplates {
    ...
    @Template("<table width='100%'> <tr> <td width='15%'> <div class='{0}'> <span id='{1}'></span> </div> </td> <td width='75%'> <div class='{2}'> <span id='{3}'></span> </div> </td> <td width='15%'> <div class='{4}'> <span id='{5}'></span> </div> </td> <td width='75%'> <div class='{6}'> <span id='{7}'></span> </div> </td> </tr>  <tr> <td width='15%'> <div class='{8}'> <span id='{9}'></span> </div> </td> <td width='75%'> <div class='{10}'> <span id='{11}'></span> </div> </td> <td width='15%'> <div class='{12}'> <span id='{13}'></span> </div> </td> <td width='75%'> <div class='{14}'> <span id='{15}'></span> </div> </td> <td width='15%'> <div class='{16}'> <span id='{17}'></span>  </div> </td> <td width='75%'> <div class='{18}'> <span id='{19}'></span> </div> </td> </tr>  <tr> <td width='15%'> <div class='{20}'> <span id='{21}'></span> </div> </td> <td width='75%'> <div class='{22}'> <span id='{23}'></span> </div> </td> </tr> </table> <div> <span id='{24}'></span> <span id='{25}'></span> </div>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.anova.anovacloud.client.application.customers.customer.CustomerView owner) {
   ...
   */
  class Widgets {
    private final com.anova.anovacloud.client.application.customers.customer.CustomerView owner;
    ...
    public Widgets(final com.anova.anovacloud.client.application.customers.customer.CustomerView owner) {
      this.owner = owner;
    ...
    SafeHtml template_html3() {
      return template.html3("" + get_style().formRow() + "", get_domId0(), "" + get_style().formRow() + "", get_domId1(), "" + get_style().formRow() + "", get_domId2(), "" + get_style().formRow() + "", get_domId3(), "" + get_style().formRow() + "", get_domId4(), "" + get_style().formRow() + "", get_domId5(), "" + get_style().formRow() + "", get_domId6(), "" + get_style().formRow() + "", get_domId7(), "" + get_style().formRow() + "", get_domId8(), "" + get_style().formRow() + "", get_domId9(), "" + get_style().formRow() + "", get_domId10(), "" + get_style().formRow() + "", get_domId11(), get_domId12(), get_domId13());
    }

    /**
     * Getter for clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay called 1 times. Type: GENERATED_BUNDLE. Build precedence: 1.
     */
    private com.anova.anovacloud.client.application.customers.customer.CustomerView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.anova.anovacloud.client.application.customers.customer.CustomerView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.anova.anovacloud.client.application.customers.customer.CustomerView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.anova.anovacloud.client.application.customers.customer.CustomerView_BinderImpl_GenBundle) GWT.create(com.anova.anovacloud.client.application.customers.customer.CustomerView_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.anova.anovacloud.client.application.customers.customer.CustomerView_BinderImpl_GenCss_style style;
    private com.anova.anovacloud.client.application.customers.customer.CustomerView_BinderImpl_GenCss_style get_style() {
      return style;
    }
    private com.anova.anovacloud.client.application.customers.customer.CustomerView_BinderImpl_GenCss_style build_style() {
      // Creation section.
