...
public class CustomerView_SimpleBeanEditorDelegate extends com.google.gwt.editor.client.impl.SimpleBeanEditorDelegate {
  private com.anova.anovacloud.client.application.customers.customer.CustomerView editor;
  @Override protected com.anova.anovacloud.client.application.customers.customer.CustomerView getEditor() {return editor;}
  protected void setEditor(com.google.gwt.editor.client.Editor editor) {this.editor=(com.anova.anovacloud.client.application.customers.customer.CustomerView)editor;}
  ...
  @Override public void accept(com.google.gwt.editor.client.EditorVisitor visitor) {
    ...
    {
      com.anova.anovacloud.client.application.customers.customer.CustomerView_name_Context ctx = new com.anova.anovacloud.client.application.customers.customer.CustomerView_name_Context(getObject(), editor.name.asEditor(), appendPath("name"));
      ctx.setEditorDelegate(nameDelegate);
      ctx.traverse(visitor, nameDelegate);
    }
    if (refNumDelegate != null) 
    {
      com.anova.anovacloud.client.application.customers.customer.CustomerView_refNum_Context ctx = new com.anova.anovacloud.client.application.customers.customer.CustomerView_refNum_Context(getObject(), editor.refNum.asEditor(), appendPath("refNum"));
      ctx.setEditorDelegate(refNumDelegate);
      ctx.traverse(visitor, refNumDelegate);
    }
    if (addressDelegate != null) 
    {
      com.anova.anovacloud.client.application.customers.customer.CustomerView_address_Context ctx = new com.anova.anovacloud.client.application.customers.customer.CustomerView_address_Context(getObject(), editor.address.asEditor(), appendPath("address"));
      ctx.setEditorDelegate(addressDelegate);
      ctx.traverse(visitor, addressDelegate);
    }
    if (emailDelegate != null) 
    {
      com.anova.anovacloud.client.application.customers.customer.CustomerView_email_Context ctx = new com.anova.anovacloud.client.application.customers.customer.CustomerView_email_Context(getObject(), editor.email.asEditor(), appendPath("email"));
      ctx.setEditorDelegate(emailDelegate);
      ctx.traverse(visitor, emailDelegate);
    }
    if (phoneDelegate != null) 
    {
      com.anova.anovacloud.client.application.customers.customer.CustomerView_phone_Context ctx = new com.anova.anovacloud.client.application.customers.customer.CustomerView_phone_Context(getObject(), editor.phone.asEditor(), appendPath("phone"));
      ctx.setEditorDelegate(phoneDelegate);
      ctx.traverse(visitor, phoneDelegate);
    }
    if (faxDelegate != null) 
    {
      com.anova.anovacloud.client.application.customers.customer.CustomerView_fax_Context ctx = new com.anova.anovacloud.client.application.customers.customer.CustomerView_fax_Context(getObject(), editor.fax.asEditor(), appendPath("fax"));
