...
public class MatterActionDetailView_matter_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<com.anova.anovacloud.shared.dto.MatterDto> {
  private final com.anova.anovacloud.shared.dto.MatterActionDto parent;
  public MatterActionDetailView_matter_Context(com.anova.anovacloud.shared.dto.MatterActionDto parent, com.google.gwt.editor.client.Editor<com.anova.anovacloud.shared.dto.MatterDto> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
