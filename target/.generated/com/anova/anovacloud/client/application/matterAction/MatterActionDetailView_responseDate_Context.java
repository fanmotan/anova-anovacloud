...
public class MatterActionDetailView_responseDate_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<java.util.Date> {
  private final com.anova.anovacloud.shared.dto.MatterActionDto parent;
  public MatterActionDetailView_responseDate_Context(com.anova.anovacloud.shared.dto.MatterActionDto parent, com.google.gwt.editor.client.Editor<java.util.Date> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
  ...
  @Override public java.util.Date getFromModel() {
    return (parent != null && true) ? parent.getResponseDate() : null;
  }
  @Override public void setInModel(java.util.Date data) {
    parent.setResponseDate(data);
  }
}
