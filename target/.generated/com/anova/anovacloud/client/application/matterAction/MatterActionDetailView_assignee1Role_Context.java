...
public class MatterActionDetailView_assignee1Role_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<com.anova.anovacloud.shared.dto.AttorneyRoleDto> {
  private final com.anova.anovacloud.shared.dto.MatterActionDto parent;
  public MatterActionDetailView_assignee1Role_Context(com.anova.anovacloud.shared.dto.MatterActionDto parent, com.google.gwt.editor.client.Editor<com.anova.anovacloud.shared.dto.AttorneyRoleDto> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
