...
public class EditMatterActionView_ptoMailDate_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<java.util.Date> {
  private final com.anova.anovacloud.shared.dto.MatterActionDto parent;
  public EditMatterActionView_ptoMailDate_Context(com.anova.anovacloud.shared.dto.MatterActionDto parent, com.google.gwt.editor.client.Editor<java.util.Date> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
