...
public class MatterActionView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.anova.anovacloud.client.application.matterAction.MatterActionView>, com.anova.anovacloud.client.application.matterAction.MatterActionView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.anova.anovacloud.client.application.matterAction.MatterActionView owner) {
   ...
   */
  class Widgets {
    private final com.anova.anovacloud.client.application.matterAction.MatterActionView owner;
    ...
    public Widgets(final com.anova.anovacloud.client.application.matterAction.MatterActionView owner) {
      this.owner = owner;
     ...
     */
    private com.anova.anovacloud.client.application.matterAction.MatterActionView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.anova.anovacloud.client.application.matterAction.MatterActionView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.anova.anovacloud.client.application.matterAction.MatterActionView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.anova.anovacloud.client.application.matterAction.MatterActionView_BinderImpl_GenBundle) GWT.create(com.anova.anovacloud.client.application.matterAction.MatterActionView_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.anova.anovacloud.client.application.matterAction.MatterActionView_BinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.anova.anovacloud.client.application.matterAction.MatterActionView_BinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.anova.anovacloud.client.application.matterAction.MatterActionView_BinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.InlineLabel build_f_InlineLabel2() {
      ...
      // Setup section.
      f_InlineLabel2.setText("MatterActions");
    ...
    private com.google.gwt.user.client.ui.Button build_create() {
      ...
      // Setup section.
      create.ensureDebugId("matterActionCreate");
    ...
    /**
     * Getter for matterActionGrid called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.cellview.client.CellTable get_matterActionGrid() {
      return build_matterActionGrid();
    }
    private com.google.gwt.user.cellview.client.CellTable build_matterActionGrid() {
      // Creation section.
      final com.google.gwt.user.cellview.client.CellTable matterActionGrid = owner.matterActionGrid;
