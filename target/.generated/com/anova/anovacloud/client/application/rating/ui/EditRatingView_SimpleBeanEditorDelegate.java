...
public class EditRatingView_SimpleBeanEditorDelegate extends com.google.gwt.editor.client.impl.SimpleBeanEditorDelegate {
  private com.anova.anovacloud.client.application.rating.ui.EditRatingView editor;
  @Override protected com.anova.anovacloud.client.application.rating.ui.EditRatingView getEditor() {return editor;}
  protected void setEditor(com.google.gwt.editor.client.Editor editor) {this.editor=(com.anova.anovacloud.client.application.rating.ui.EditRatingView)editor;}
  ...
  @Override public void accept(com.google.gwt.editor.client.EditorVisitor visitor) {
    ...
    {
      com.anova.anovacloud.client.application.rating.ui.EditRatingView_rating_Context ctx = new com.anova.anovacloud.client.application.rating.ui.EditRatingView_rating_Context(getObject(), editor.rating.asEditor(), appendPath("rating"));
      ctx.setEditorDelegate(ratingDelegate);
      ctx.traverse(visitor, ratingDelegate);
    }
    if (matterDelegate != null) 
    {
      com.anova.anovacloud.client.application.rating.ui.EditRatingView_matter_Context ctx = new com.anova.anovacloud.client.application.rating.ui.EditRatingView_matter_Context(getObject(), editor.matter.asEditor(), appendPath("matter"));
