...
public class RatingDetailView_rating_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<java.lang.Integer> {
  private final com.anova.anovacloud.shared.dto.RatingDto parent;
  public RatingDetailView_rating_Context(com.anova.anovacloud.shared.dto.RatingDto parent, com.google.gwt.editor.client.Editor<java.lang.Integer> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
