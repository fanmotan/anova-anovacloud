...
public class RatingDetailView_matter_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<com.anova.anovacloud.shared.dto.MatterDto> {
  private final com.anova.anovacloud.shared.dto.RatingDto parent;
  public RatingDetailView_matter_Context(com.anova.anovacloud.shared.dto.RatingDto parent, com.google.gwt.editor.client.Editor<com.anova.anovacloud.shared.dto.MatterDto> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
