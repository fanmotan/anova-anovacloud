...
public class CustomerDetailView_fax_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<java.lang.String> {
  private final com.anova.anovacloud.shared.dto.CustomerDto parent;
  public CustomerDetailView_fax_Context(com.anova.anovacloud.shared.dto.CustomerDto parent, com.google.gwt.editor.client.Editor<java.lang.String> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
