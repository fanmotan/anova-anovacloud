...
public class EditCustomerView_SimpleBeanEditorDelegate extends com.google.gwt.editor.client.impl.SimpleBeanEditorDelegate {
  ...
  @Override public void accept(com.google.gwt.editor.client.EditorVisitor visitor) {
    ...
    {
      com.anova.anovacloud.client.application.customer.ui.EditCustomerView_code_Context ctx = new com.anova.anovacloud.client.application.customer.ui.EditCustomerView_code_Context(getObject(), editor.code.asEditor(), appendPath("code"));
    ...
    {
      com.anova.anovacloud.client.application.customer.ui.EditCustomerView_customerStatus_Context ctx = new com.anova.anovacloud.client.application.customer.ui.EditCustomerView_customerStatus_Context(getObject(), editor.customerStatus.asEditor(), appendPath("customerStatus"));
