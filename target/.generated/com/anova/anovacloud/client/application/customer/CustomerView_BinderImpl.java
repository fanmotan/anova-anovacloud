...
public class CustomerView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.anova.anovacloud.client.application.customer.CustomerView>, com.anova.anovacloud.client.application.customer.CustomerView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.anova.anovacloud.client.application.customer.CustomerView owner) {
   ...
   */
  class Widgets {
    private final com.anova.anovacloud.client.application.customer.CustomerView owner;
    ...
    public Widgets(final com.anova.anovacloud.client.application.customer.CustomerView owner) {
      this.owner = owner;
     ...
     */
    private com.anova.anovacloud.client.application.customer.CustomerView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.anova.anovacloud.client.application.customer.CustomerView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.anova.anovacloud.client.application.customer.CustomerView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.anova.anovacloud.client.application.customer.CustomerView_BinderImpl_GenBundle) GWT.create(com.anova.anovacloud.client.application.customer.CustomerView_BinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.InlineLabel build_f_InlineLabel2() {
      ...
      // Setup section.
      f_InlineLabel2.setText("Customers");
    ...
    private com.google.gwt.user.client.ui.Button build_create() {
      ...
      // Setup section.
      create.ensureDebugId("create-customer");
