...
public class UserView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.anova.anovacloud.client.application.user.UserView>, com.anova.anovacloud.client.application.user.UserView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.anova.anovacloud.client.application.user.UserView owner) {
   ...
   */
  class Widgets {
    private final com.anova.anovacloud.client.application.user.UserView owner;
    ...
    public Widgets(final com.anova.anovacloud.client.application.user.UserView owner) {
      this.owner = owner;
     ...
     */
    private com.anova.anovacloud.client.application.user.UserView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.anova.anovacloud.client.application.user.UserView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.anova.anovacloud.client.application.user.UserView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.anova.anovacloud.client.application.user.UserView_BinderImpl_GenBundle) GWT.create(com.anova.anovacloud.client.application.user.UserView_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.anova.anovacloud.client.application.user.UserView_BinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.anova.anovacloud.client.application.user.UserView_BinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.anova.anovacloud.client.application.user.UserView_BinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.Button build_create() {
      ...
      // Setup section.
      create.ensureDebugId("create-user");
    ...
    /**
     * Getter for userGrid called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.cellview.client.CellTable get_userGrid() {
      return build_userGrid();
    }
    private com.google.gwt.user.cellview.client.CellTable build_userGrid() {
      // Creation section.
      final com.google.gwt.user.cellview.client.CellTable userGrid = owner.userGrid;
      assert userGrid != null : "UiField userGrid with 'provided = true' was null";
      // Setup section.
      userGrid.ensureDebugId("users");
