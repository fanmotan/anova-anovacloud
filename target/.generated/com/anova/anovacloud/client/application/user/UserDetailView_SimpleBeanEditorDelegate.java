...
public class UserDetailView_SimpleBeanEditorDelegate extends com.google.gwt.editor.client.impl.SimpleBeanEditorDelegate {
  ...
  @Override public void accept(com.google.gwt.editor.client.EditorVisitor visitor) {
    ...
    {
      com.anova.anovacloud.client.application.user.UserDetailView_role_Context ctx = new com.anova.anovacloud.client.application.user.UserDetailView_role_Context(getObject(), editor.role.asEditor(), appendPath("role"));
      ctx.setEditorDelegate(roleDelegate);
      ctx.traverse(visitor, roleDelegate);
    }
    if (mailAddressDelegate != null) 
    {
      com.anova.anovacloud.client.application.user.UserDetailView_mailAddress_Context ctx = new com.anova.anovacloud.client.application.user.UserDetailView_mailAddress_Context(getObject(), editor.mailAddress.asEditor(), appendPath("mailAddress"));
    ...
    {
      com.anova.anovacloud.client.application.user.UserDetailView_phone_Context ctx = new com.anova.anovacloud.client.application.user.UserDetailView_phone_Context(getObject(), editor.phone.asEditor(), appendPath("phone"));
      ctx.setEditorDelegate(phoneDelegate);
      ctx.traverse(visitor, phoneDelegate);
    }
    if (faxDelegate != null) 
    {
      com.anova.anovacloud.client.application.user.UserDetailView_fax_Context ctx = new com.anova.anovacloud.client.application.user.UserDetailView_fax_Context(getObject(), editor.fax.asEditor(), appendPath("fax"));
