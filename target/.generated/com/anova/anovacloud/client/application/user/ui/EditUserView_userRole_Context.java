...
public class EditUserView_userRole_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<com.anova.anovacloud.shared.dto.UserRoleDto> {
  private final com.anova.anovacloud.shared.dto.UserDto parent;
  public EditUserView_userRole_Context(com.anova.anovacloud.shared.dto.UserDto parent, com.google.gwt.editor.client.Editor<com.anova.anovacloud.shared.dto.UserRoleDto> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
