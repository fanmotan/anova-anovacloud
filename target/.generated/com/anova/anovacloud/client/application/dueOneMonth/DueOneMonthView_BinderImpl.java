...
public class DueOneMonthView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView>, com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView owner) {
   ...
   */
  class Widgets {
    private final com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView owner;


    public Widgets(final com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView owner) {
      this.owner = owner;
     ...
     */
    private com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView_BinderImpl_GenBundle) GWT.create(com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView_BinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView_BinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.anova.anovacloud.client.application.dueOneMonth.DueOneMonthView_BinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.InlineLabel build_f_InlineLabel2() {
      ...
      // Setup section.
      f_InlineLabel2.setText("Actions Due in One Month");
