...
public class AttorneyView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.anova.anovacloud.client.application.attorney.AttorneyView>, com.anova.anovacloud.client.application.attorney.AttorneyView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.anova.anovacloud.client.application.attorney.AttorneyView owner) {
   ...
   */
  class Widgets {
    private final com.anova.anovacloud.client.application.attorney.AttorneyView owner;
    ...
    public Widgets(final com.anova.anovacloud.client.application.attorney.AttorneyView owner) {
      this.owner = owner;
     ...
     */
    private com.anova.anovacloud.client.application.attorney.AttorneyView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.anova.anovacloud.client.application.attorney.AttorneyView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.anova.anovacloud.client.application.attorney.AttorneyView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.anova.anovacloud.client.application.attorney.AttorneyView_BinderImpl_GenBundle) GWT.create(com.anova.anovacloud.client.application.attorney.AttorneyView_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.anova.anovacloud.client.application.attorney.AttorneyView_BinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.anova.anovacloud.client.application.attorney.AttorneyView_BinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.anova.anovacloud.client.application.attorney.AttorneyView_BinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Setup section.
      f_HTMLPanel1.ensureDebugId("attorneyPanel");
      ...
      f_HTMLPanel1.addAndReplaceElement(get_attorneyGrid(), get_domId2Element().get());
    ...
    private com.google.gwt.user.client.ui.InlineLabel build_f_InlineLabel2() {
      ...
      // Setup section.
      f_InlineLabel2.setText("Attorneys");
    ...
    private com.google.gwt.user.client.ui.Button build_create() {
      ...
      // Setup section.
      create.ensureDebugId("create-attorney");
    ...
    /**
     * Getter for attorneyGrid called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.cellview.client.CellTable get_attorneyGrid() {
      return build_attorneyGrid();
    }
    private com.google.gwt.user.cellview.client.CellTable build_attorneyGrid() {
      // Creation section.
      final com.google.gwt.user.cellview.client.CellTable attorneyGrid = owner.attorneyGrid;
      assert attorneyGrid != null : "UiField attorneyGrid with 'provided = true' was null";
      // Setup section.
      attorneyGrid.ensureDebugId("attorneys");
      attorneyGrid.setWidth("100%");
