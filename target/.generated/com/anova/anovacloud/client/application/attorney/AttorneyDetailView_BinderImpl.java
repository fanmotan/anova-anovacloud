...
public class AttorneyDetailView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.anova.anovacloud.client.application.attorney.AttorneyDetailView>, com.anova.anovacloud.client.application.attorney.AttorneyDetailView.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.anova.anovacloud.client.application.attorney.AttorneyDetailView owner) {
   ...
   */
  class Widgets {
    private final com.anova.anovacloud.client.application.attorney.AttorneyDetailView owner;


    public Widgets(final com.anova.anovacloud.client.application.attorney.AttorneyDetailView owner) {
      this.owner = owner;
     ...
     */
    private com.anova.anovacloud.client.application.attorney.AttorneyDetailView_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.anova.anovacloud.client.application.attorney.AttorneyDetailView_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.anova.anovacloud.client.application.attorney.AttorneyDetailView_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.anova.anovacloud.client.application.attorney.AttorneyDetailView_BinderImpl_GenBundle) GWT.create(com.anova.anovacloud.client.application.attorney.AttorneyDetailView_BinderImpl_GenBundle.class);
      // Setup section.
    ...
    /**
     * Getter for resource called 9 times. Type: IMPORTED. Build precedence: 1.
     */
     ...
     */
    private com.anova.anovacloud.client.application.attorney.AttorneyDetailView_BinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.anova.anovacloud.client.application.attorney.AttorneyDetailView_BinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.anova.anovacloud.client.application.attorney.AttorneyDetailView_BinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      f_HTMLPanel1.addAndReplaceElement(get_attorneyname(), get_domId3Element().get());
    ...
    /**
     * Getter for attorneyname called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    ...
    private com.google.gwt.user.client.ui.TextBox build_attorneyname() {
      ...
      // Setup section.
      attorneyname.setStyleName("" + get_resource().styles().mobileTextField() + "");
