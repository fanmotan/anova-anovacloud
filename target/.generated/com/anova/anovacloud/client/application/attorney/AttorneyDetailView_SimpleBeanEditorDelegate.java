...
public class AttorneyDetailView_SimpleBeanEditorDelegate extends com.google.gwt.editor.client.impl.SimpleBeanEditorDelegate {
  ...
  @Override public void accept(com.google.gwt.editor.client.EditorVisitor visitor) {
    ...
    {
      com.anova.anovacloud.client.application.attorney.AttorneyDetailView_attorneyname_Context ctx = new com.anova.anovacloud.client.application.attorney.AttorneyDetailView_attorneyname_Context(getObject(), editor.attorneyname.asEditor(), appendPath("attorneyname"));
      ctx.setEditorDelegate(attorneynameDelegate);
      ctx.traverse(visitor, attorneynameDelegate);
    }
    if (hashPasswordDelegate != null) 
    {
      com.anova.anovacloud.client.application.attorney.AttorneyDetailView_hashPassword_Context ctx = new com.anova.anovacloud.client.application.attorney.AttorneyDetailView_hashPassword_Context(getObject(), editor.hashPassword.asEditor(), appendPath("hashPassword"));
