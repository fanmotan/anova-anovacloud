...
public class AttorneyDetailView_lastName_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<java.lang.String> {
  private final com.anova.anovacloud.shared.dto.AttorneyDto parent;
  public AttorneyDetailView_lastName_Context(com.anova.anovacloud.shared.dto.AttorneyDto parent, com.google.gwt.editor.client.Editor<java.lang.String> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
