...
public class MatterPropertiesEditor_caseTitle_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<java.lang.String> {
  private final com.anova.anovacloud.shared.dto.MatterPropertiesDto parent;
  public MatterPropertiesEditor_caseTitle_Context(com.anova.anovacloud.shared.dto.MatterPropertiesDto parent, com.google.gwt.editor.client.Editor<java.lang.String> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
  ...
  @Override public java.lang.String getFromModel() {
    return (parent != null && true) ? parent.getCaseTitle() : null;
  }
  @Override public void setInModel(java.lang.String data) {
    parent.setCaseTitle(data);
  }
}
