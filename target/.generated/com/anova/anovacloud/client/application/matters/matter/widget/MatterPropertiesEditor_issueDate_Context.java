...
public class MatterPropertiesEditor_issueDate_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<java.util.Date> {
  private final com.anova.anovacloud.shared.dto.MatterPropertiesDto parent;
  public MatterPropertiesEditor_issueDate_Context(com.anova.anovacloud.shared.dto.MatterPropertiesDto parent, com.google.gwt.editor.client.Editor<java.util.Date> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
  ...
  @Override public java.util.Date getFromModel() {
    return (parent != null && true) ? parent.getIssueDate() : null;
  }
  @Override public void setInModel(java.util.Date data) {
    parent.setIssueDate(data);
  }
}
