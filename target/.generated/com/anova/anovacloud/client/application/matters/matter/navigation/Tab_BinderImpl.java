...
public class Tab_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.anova.anovacloud.client.application.matters.matter.navigation.Tab>, com.anova.anovacloud.client.application.matters.matter.navigation.Tab.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.anova.anovacloud.client.application.matters.matter.navigation.Tab owner) {
   ...
   */
  class Widgets {
    private final com.anova.anovacloud.client.application.matters.matter.navigation.Tab owner;
    ...
    public Widgets(final com.anova.anovacloud.client.application.matters.matter.navigation.Tab owner) {
      this.owner = owner;
     ...
     */
    private com.anova.anovacloud.client.application.matters.matter.navigation.Tab_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.anova.anovacloud.client.application.matters.matter.navigation.Tab_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.anova.anovacloud.client.application.matters.matter.navigation.Tab_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.anova.anovacloud.client.application.matters.matter.navigation.Tab_BinderImpl_GenBundle) GWT.create(com.anova.anovacloud.client.application.matters.matter.navigation.Tab_BinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord23 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
