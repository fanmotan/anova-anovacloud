package com.anova.anovacloud.client.application.dueOneWeek.renderer;
...
public class DueOneWeekCell extends AbstractCell<MatterActionDto> {
    ...
    @Inject
    DueOneWeekCell(Renderer uiRenderer) {
