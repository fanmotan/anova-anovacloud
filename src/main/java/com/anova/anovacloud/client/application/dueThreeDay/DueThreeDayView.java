...
public class DueThreeDayView extends ViewImpl implements DueThreeDayPresenter.MyView {
    interface Binder extends UiBinder<Widget, DueThreeDayView> {
    }
    ...
    @Inject
    DueThreeDayView(Binder uiBinder) {
