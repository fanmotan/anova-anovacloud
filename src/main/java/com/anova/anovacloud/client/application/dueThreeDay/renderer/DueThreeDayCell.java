package com.anova.anovacloud.client.application.dueThreeDay.renderer;
...
public class DueThreeDayCell extends AbstractCell<MatterActionDto> {
    ...
    @Inject
    DueThreeDayCell(Renderer uiRenderer) {
