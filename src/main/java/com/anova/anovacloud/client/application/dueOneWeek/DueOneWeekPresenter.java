...
public class DueOneWeekPresenter extends Presenter<DueOneWeekPresenter.MyView, DueOneWeekPresenter.MyProxy> {
    interface MyView extends View {
        void displayReport(List<MatterActionDto> actionDues);
    }

    @ProxyCodeSplit
    @NameToken(NameTokens.DUEONEWEEK)
    interface MyProxy extends ProxyPlace<DueOneWeekPresenter> {
    }
    ...
    @Inject
    DueOneWeekPresenter(EventBus eventBus,
                    MyView view,
                    MyProxy proxy,
