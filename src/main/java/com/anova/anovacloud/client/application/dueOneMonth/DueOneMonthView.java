...
public class DueOneMonthView extends ViewImpl implements DueOneMonthPresenter.MyView {
    interface Binder extends UiBinder<Widget, DueOneMonthView> {
    }
    ...
    @Inject
    DueOneMonthView(Binder uiBinder) {
