...
public class DueOneMonthPresenter extends Presenter<DueOneMonthPresenter.MyView, DueOneMonthPresenter.MyProxy> {
    interface MyView extends View {
        void displayReport(List<MatterActionDto> actionDues);
    }

    @ProxyCodeSplit
    @NameToken(NameTokens.DUEONEMONTH)
    interface MyProxy extends ProxyPlace<DueOneMonthPresenter> {
    }
    ...
    @Inject
    DueOneMonthPresenter(EventBus eventBus,
                    MyView view,
                    MyProxy proxy,
